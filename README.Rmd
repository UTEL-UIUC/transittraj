...
``` {r, echo = FALSE, out.width = "100%", fig.align = "center", fig.cap = "`transittraj` converts noisy GPS data (left) to a trajectory (right) meeting the four requirements discussed below"}
knitr::include_graphics("man/figures/README-example2.jpg")
```
...
visualize and apply fit trajectory curves. Check out the vignettes below to
get started.
