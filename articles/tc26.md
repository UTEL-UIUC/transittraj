...
that produced the figures and stats you on our poster at Transport
Chicago 2026. As this is intended to supplement the poster presentation,
we will only minimally discuss our code here. If you have additional
...
Additionally, the data we used here was shared with is privately by
IndyGo via their Swiftly API endpoint. As such, we unfortunately cannot
share the raw AVL data. It has been preloaded into our RStudio workspace
before running this vignette’s code (as `avl_df`).
...
#> 2 1 & 2 1338872    3173 348.7453310 -287709 -17.6879602          -4 -0.12590494
#> 3     3 1332860    3158   1.8031750   -6012  -0.4490347         -15 -0.47273873
#> 4     4 1330548    3158  63.2310128   -2312  -0.1734616           0  0.00000000
#> 5     5 1248044    2897   0.9946151  -82504  -6.2007534        -261 -8.26472451
#> 6     6 1241429    2896   0.3930848   -6615  -0.5300294          -1 -0.03451847
#> 7     7 1241429    2896 216.4817820       0   0.0000000           0  0.00000000
#> 8 Final      NA    2896  37.7066591      NA          NA           0  0.00000000
```
...
t_f <- Sys.time()
print(t_f - t_0)
#> Time difference of 1.270123 secs
```
...
t_f <- Sys.time()
print(t_f - t_0)
#> Time difference of 21.15957 secs
...
t_f <- Sys.time()
print(t_f - t_0)
#> Time difference of 19.66118 secs
```
