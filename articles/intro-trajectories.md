...
![](intro-trajectories_files/figure-html/unnamed-chunk-13-1.png)
...
![](intro-trajectories_files/figure-html/unnamed-chunk-16-1.png)
...
![](intro-trajectories_files/figure-html/unnamed-chunk-17-1.png)
...
You can view the line animation online at [this
link](https://www.youtube.com/watch?v=ctW5dI1069o). The animation shows
us that most trips stop primarily at their stations, usually only
briefly. There are, though, occasional slow downs between stations, most
commonly between LATTC and Pico (as we saw in the trajectory plot
above). Through the rest of downtown, movements seem to be smoother.
...
You can view the map animation line at [this
link](https://www.youtube.com/watch?v=F9Cg8bZNk5A). These animations
help give additional spatial context to some patterns noticed earlier.
Many slowdowns between stations that were visible in the trajectories
now clearly occur at intersections. For example, a particularly long
delay at Flower & Washington – just south of the I-10 freeway – is
visible at around 0:34. We can also see some potential bunching: two
trains get fairly close on Exposition Blvd, just southwest of downtown,
at around 0:14. They stay close through downtown, and finish their trips
only a ~3 minutes apart at 0:25. If one wanted to zoom into a specific
region, `distance_lims` can be used just as before.
