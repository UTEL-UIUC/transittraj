...
- **Benjamin O'Brien**. Author, maintainer, copyright holder.
...
Source:
[`DESCRIPTION`](https://github.com/UTEL-UIUC/transittraj/blob/v0.1.4/DESCRIPTION)

O'Brien B, Lehe L (2026). *transittraj: Reconstruct and Visualize
Transit Vehicle Trajectories*. R package version 0.1.4,
