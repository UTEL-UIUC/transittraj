...
does with `plot_trajector()`. For this plot, we'll also set some distance
...
export_animation(anim_object = line_anim,
                 path = "C:\\Users\\obrie\\Desktop\\c53_Florida_U_example.gif",
                 duration = 45,
                 dpi = 200,
                 height = 6,
                 width = 3.5)
...
``` {r, echo = FALSE}
knitr::include_graphics("https://drive.google.com/uc?id=1qQPA2Qlwqe5qiO3F80wLKdzcNC_6Ve9f")
```
...
This function has formatting and feature options very similar to the previous
...
export_animation(anim_object = map_anim,
                 path = "C:\\Users\\obrie\\Desktop\\c53_map_example.gif",
                 duration = 45,
                 dpi = 200,
                 height = 6,
                 width = 5.5)
...
``` {r, echo = FALSE}
knitr::include_graphics("https://drive.google.com/uc?id=1hMztRPm9CanWyOMXwB8kGknn04fhB-fN")
```
