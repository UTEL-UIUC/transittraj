...
trips. This seven-step process is summarized in the figure below.

``` {r, echo = FALSE, out.width = "60%", fig.align = "center", fig.cap = "`transittraj` AVL cleaning process"}
knitr::include_graphics("figures/avl-cleaning-workflow.png")
```

Check out `vignette("articles/input-data-la")` to learn more about the AVL and GTFS data
we'll be using. Let's begin by loading the libraries we'll be using:
...
``` {r, out.width = "100%", dpi = 800, fig.align = "center", fig.width = 4, fig.height = 1}
...
[Division 21](https://maps.app.goo.gl/2e6w3UPaXsSrR943A) yard. These points
...
must meet certain conditions (known as [Fritsch-Carlson constraints](https://epubs.siam.org/doi/10.1137/0717021)) in order to
...
(`vignette("articles/intro-trajectories-la")`) we will fit and explore these
