...
Georgia, either to serve the stop or for the signal. One trip sits there
...
There are many formatting features available through `plot_trajector()`. Check
...
The animation shows us that most trips stop mostly at their stops, either due
