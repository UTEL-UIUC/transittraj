...
You'll notice that we've uploaded this animation to YouTube and embedded it in
the vignette. We did this so we could produce a smooth, high-resolution video
that doesn't need to be re-rendered every time this vignette is built. By
